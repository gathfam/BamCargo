...
import { useCostMtr, useDestinations } from '@/hooks/api-hit';
...
export function CekOngkirMotorForm({
    className,
    ...props
}: CekOngkirMotorFormProps) {
    const [Silinder, setSilinder] = useState<string>('');
