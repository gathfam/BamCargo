  ...
  return (
    ...
    >
      <Primitive.div
        ...
        className={cn(
          "selection:bg-primary selection:text-primary-foreground dark:bg-input/30 flex min-h-10 cursor-text items-center gap-2 rounded-sm border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none md:text-sm border-[#ccc]",
