    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          role="combobox"
          className={cn("justify-between h-12 truncate", POPOVER_WIDTH)}
        >
          {displayName}
      ...
      <PopoverContent
        side="bottom"
        className={cn("p-0 w-full! max-w-180", POPOVER_WIDTH)}
      >
