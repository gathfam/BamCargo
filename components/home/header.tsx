...
const sections: Section[] = [
  {
    label: "Menu",
    items: [
      { title: "Halaman Utama", href: "/", icon: Home },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Galeri", href: "/gallery", icon: ImageIcon },
      { title: "Testimonial", href: "/testimonial", icon: MessageSquare },
      { title: "Karir", href: "/career", icon: Users },
      { title: "Hubungi Kami", href: "/contact", icon: PhoneCall },
    ],
  },
];
...
export function HeaderHome() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 dark:border-neutral-800 bg-white/90  dark:bg-background/90 backdrop-blur-md">
      <div className="max-w-400 mx-auto hidden h-16 md:flex items-center px-6 justify-between">
